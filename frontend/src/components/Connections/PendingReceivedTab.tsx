...
interface PendingReceivedTabProps {
    ...
    respondToRequest: (id: string, action: 'ACCEPTED' | 'REJECTED' | 'BLOCKED') => void;
                        ...
                        <CardActions sx={{
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    color: (theme) => theme.palette.mode === 'dark' ? '#38ef7d' : '#28a745',
                                    '&:hover': {
                                        background: (theme) => theme.palette.mode === 'dark'
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    color: (theme) => theme.palette.mode === 'dark' ? '#ef3838' : '#dc3545',
                                    '&:hover': {
                                        background: (theme) => theme.palette.mode === 'dark'
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    color: (theme) => theme.palette.mode === 'dark' ? '#9370DB' : '#800080',
                                    '&:hover': {
                                        background: (theme) => theme.palette.mode === 'dark'
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        ...
                        The user will not be able to send you connection requests in the future.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
