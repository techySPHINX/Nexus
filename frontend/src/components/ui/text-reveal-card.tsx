    ...
    >
      ...
      <div className="h-24 relative flex items-center overflow-hidden">
        {/* <motion.div
          ...
          className="absolute bg-white dark:bg-green-200 z-20  will-change-transform"
        >
          <p
            style={{
              textShadow: '4px 4px 15px rgba(0,0,0,0.5)',
            }}
            className="text-base sm:text-[3rem] py-10 font-bold leading-[0.8] text-black bg-clip-text text-transparent bg-gradient-to-b from-black to-neutral-300"
          >
            {revealText}
          </p>
        </motion.div> */}
