  ...
  const createProjectUpdate = useCallback(
    async (projectId: string, data: CreateProjectUpdateInterface) => {
      ...
      try {
        ...
        console.log('updates after creation', updates);
      } catch (err) {
        setError(
